            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        <img id="image_id" class="img-fluid" src="uploads/0.jpg" alt="" class="hidden">
                        <!-- <div id="notification">
                          <p>test</p>
                        </div> -->
                        <div class="col-md-12">
                    ...
                    <button id="take_perfect" class="btn btn-success btn-sm">Take Perfect</button>
                    <button style="visibility: hidden" id="take_snapshots" class="btn btn-success btn-sm">Take Snapshots</button>
                    <button style="visibility: hidden" id="compare" class="btn btn-success btn-sm">compare</button>
                    <br><br>
                    <div style="display:none;">
                      <button id='igl'>Ignore Less</button>
                  		<button id='igc'>Ignore Colors</button>
                      <button id='iganti'>Ignore Antialiasing</button>
                      <button id='igalpha'>Ignore Alpha</button>
                    </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="card d-block">
                                    <div class="card-body">
                                        ...
                                        <div class="badge badge-primary mb-3">Ongoing</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <h5>Start Date</h5>
                                                    <p>17 March 2018 <small class="text-muted">12:00 </small></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <h5>Last check</h5>
                                                    <p>22 December 2018 <small class="text-muted">11:55 </small></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <h5>Budget</h5>
                                                    <p>€15,800 <small class="text-muted">/per month</small></p>
                                                </div>
                                            </div>
                                        </div>
...
<script>
  ...
  $('#take_perfect').click(function(){
    var snapshot = camera.capture();
    snapshot.show();

    snapshot.upload({api_url: "action2.php"}).done(function(response) {
$('#imagelist').prepend("<tr><td><img src='"+response+"' width='100px' height='100px'></td><td>"+response+"</td></tr>");
}).fail(function(response) {
  alert("Upload failed with status " + response);
});

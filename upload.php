                ...
                <ul class="metismenu side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <ul class="side-nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="profile-seller.html"><strong>NEW</strong> - Profile seller</a>
                            </li>
                            <li>
                                <a href="profile-buyer.html"><strong>NEW</strong> - Profile buyer</a>
                            </li>
                            <li>
                                <a href="auction-new.html"><strong>NEW</strong> - Auction new</a>
                            </li>
                            <li>
                                <a href="auction-submitted.html"><strong>NEW</strong> - Auction submitted</a>
                            </li>
                            <li>
                                <a href="auction-activated.html"><strong>NEW</strong> - Auction activated</a>
                            </li>
                            <li>
                                <a href="dashboard-seller.html"><strong>NEW</strong> - Dashboard seller</a>
                            </li>
                            <li>
                                <a href="dashboard-buyer.html"><strong>NEW</strong> - Dashboard buyer</a>
                            </li>
                            <li>
                                <a href="financing-seller.html"><strong>NEW</strong> - Financing seller</a>
                            </li>
                    ...
                    <li class="side-nav-item">
                        <a href="javascript: void(0);" class="side-nav-link">
                            ...
                            <span class="badge badge-light float-right">6</span>
                            <span> Forms </span>
                        </a>
                        <ul class="side-nav-second-level" aria-expanded="false">
                            <li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="uploaded.php" method="post" enctype="multipart/form-data" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews"
